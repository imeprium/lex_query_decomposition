...
- Always be jurisdiction-aware, particularly for Nigerian law questions
...
1. Query: What constitutes insider trading under Nigerian securities law and what are the penalties?
   Decomposed Questions: [
     ...
     Question(question='What are the criminal penalties for insider trading under Nigerian law?', answer=None),
...
2. Query: What are the elements of fraud under Nigerian criminal law?
   Decomposed Questions: [
     ...
     Question(question='What specific sections of Nigerian law address different types of fraud?', answer=None),
     Question(question='What are the essential elements that must be proven for fraud under Nigerian criminal law?', answer=None),
     Question(question='How have Nigerian courts interpreted the intent requirement for fraud?', answer=None),
     Question(question='What are the differences between civil and criminal fraud in Nigerian law?', answer=None),
     Question(question='What landmark cases have shaped the interpretation of fraud elements in Nigerian courts?', answer=None)
   ]
